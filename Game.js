...
var mission = new Audio('audio/Mission Impossible.mp3');
//Starting Car Sound
var startcar = new Audio('audio/startCar.mp3');
//Crashing Car Sound
var crashcar = new Audio('audio/crash.mp3');

//Play start car sound right away
startcar.play();
//Play mission music right away
mission.play();
...
function drawElapsedTime() {
    ...
    c.fillStyle = "black";
    c.font = "30px Verdana";
    c.fillText(parseInt((Date.now() - startTime) / 1000) + " secs", canvas.width - 117, 40);
    c.restore();
}
...
if (parseInt((Date.now() - startTime) / 1000) >= 25 && parseInt((Date.now() - startTime) / 1000) <= 29){
    c.beginPath();
    c.fillStyle = "red";
    c.font = "50px Verdana";
...
function drawBackground() {
    ...
    var y =- (lineLength + voidLength) + roadPosition%(lineLength + voidLength);
